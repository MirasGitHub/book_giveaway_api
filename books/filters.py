...
class BookFilter(django_filters.FilterSet):
    ...
    owner__name__icontains = django_filters.CharFilter(field_name='owner__name', lookup_expr='icontains')
    is_available = django_filters.BooleanFilter(field_name='is_available', widget=django_filters.widgets.BooleanWidget())

    class Meta:
        model = Book
        fields = ['author__name__icontains', 'genre__name__icontains', 'condition__icontains', 'title__icontains', 'location__icontains', 'owner__name__icontains', 'is_available']
